...
<head>
	...
	$(function(){
		...
		var OFFICE_WEBAPP_SERVER_HOST_2013 = "http://192.168.18.131/hosting/discovery";
		var WOPISrc = "http://192.168.1.120:8080/wopihost/wopi/files/{0}&access_token={access_token}_{canedit}";
